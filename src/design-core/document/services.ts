...
export function searchResultToPlaced(r: ComponentSearchResult, reference: string): PlacedComponent {
  ...
  return {
    ...
    display: { description: r.description, family: r.family, attributes: r.attributes, pins: r.pins, datasheetUrl: r.datasheetUrl, imageUrl: r.imageUrl, stepUrl: r.stepUrl },
  };
}
